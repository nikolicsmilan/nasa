...
const Home = () => {
  return (
    <div className=" border-0  border-red-400 w-full">
      ...
      <div className="flex  w-full relative text-xl z-30 border-2 border-lime-400 mt-[0px] ">
        ...
        <div className=" flex flex-col border-0 md:m-10 py-2 md:py-0 text-center lg:w-1/2 md:w-3/4 border-orange-400 ">
          ...
          <div className="border-0 border-red-400  flex justify-end flex-wrap   ">
            {menu.map((item) => (
              <div className=" relative flex-col m-3  lg:w-48 md:w-40 w-32 h-28 border-0 border-red-400 ">
                <div
                  id="customshadow2"
                  className=" rounded-2xl lg:w-48 md:w-40  w-32 h-full text-sky-400 shadow-2xl border-0 bg-sky-400 md:opacity-10 opacity-10 mt-[0px] z-40"
                ></div>
                <div
                  id="customshadow2"
                  className=" rounded-2xl text-2xl opacity-100 flex h-28
               border-white  shadow-2xl items-center justify-center border-0 bg-dark-800 z-20 rounded  mt-[-110px] font-bold"
                >
