    ...
    <div className=" border-0  border-red-400 w-full">
      ...
      <div className="flex h-screen w-full relative text-xl z-30 border-0 mt-[0px] ">
        ...
        <div className=" flex flex-col border-0 w-1/2 border-lime-400 ">
          ...
          <div className="border-0 bg-black  flex flex-wrap p-10 ">
            {menu.map((item) => (
              <div   className="relative   flex-col m-5  w-48 h-28 border-0 border-red-400 ">
                ...
                id="customshadow2"
                  className="flex h-28
               border-white  shadow-2xl items-center justify-center border-2 bg-dark-800 z-20 rounded"
                >
...
#customshadow2 {
  ...
  -webkit-box-shadow: 2px 23px 30px 22px rgba(17, 104, 175, 0.75);
