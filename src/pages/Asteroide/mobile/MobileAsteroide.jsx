          ...
          >
            ...
            <div className=" flex justify-center items-center my-0 w-full border-0 border-purple-400">
              <div className="relative border-0 border-sky-400 h-96 w-full">
                {toggle && (
                  <motion.div
                    className="glowy-button-6 absolute top-0   z-10  h-16 md:w-16 h-96 rounded m-2 flex flex-col 
            ...
            <div className=" g flex flex-col justify-center items-center relative border-0 h-full border-sky-400 h-10 w-96 my-0">
              {toggle && (
                <motion.div
