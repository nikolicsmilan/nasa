  ...
  return (
    ...
    <AnimatePresence>
      <div className="border-0 border-red-400 flex justify-center items-center h-screen">
        <div
          className="border-2 p-2 border-primary flex flex-col items-center justify-center my-10 rounded-2xl w-full"
              ...
              {toggle && (
                ...
                >
                  {mainconsole.map((item) => (
                    ...
                    >
                      <span className="border-0 shadow flex justify-center items-center h-12 w-16 text-4xl">
                      {<item.icon />}
                      </span>
