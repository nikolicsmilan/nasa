...
<div className="border-0 flex justify-center gap-4">
      ...
      <div
        className="w-48 h-48 rounded-xl backdrop-blur-md bg-gradient-to-b from-sky-950/95 to-sky-800/95"
      >
        {/* NINCS BENNE SEMMI */} 
      </div>
      ...
      <div
         className="w-48 h-48 rounded-xl backdrop-blur-md  bg-gradient-to-b from-lime-950/95 to-lime-700/95"
      >
         {/* NINCS BENNE SEMMI */} 
      </div>
      ...
      <div
         className="w-48 h-48 rounded-xl backdrop-blur-md overflow-hidden bg-gradient-to-b from-green-950/95 to-green-700/95"
      >
         {/* NINCS BENNE SEMMI */}
      </div>
      ...
      <div
         className="w-48 h-48 rounded-xl backdrop-blur-md overflow-hidden bg-gradient-to-b from-blue-950/95 to-blue-800/95"
      >
         {/* NINCS BENNE SEMMI */}
      </div>
      </div>
      ...
      <h2 className="text-primary text-2xl mb-8 text-center">SpeedGauge Test Page</h2>
      <SpeedGauge
      ...
      <div className="border-0 flex flex-col items-center justify-start  w-full p-10 bg-black text-primary font-mono">
        <h1 className="text-primary text-2xl mb-8">
...
>
  ...
  <div className="relative z-10 flex flex-col items-center">
    <span className="font-bold text-lg text-[#22d3ee]" style={{ filter: `drop-shadow(0 0 5px #22d3ee)` }}>
      Plasmáb
    </span>
    <span className="text-neutral-300 text-sm mt-1">Style Button</span>
  </div>
...
>
   <div className="relative z-10 flex flex-col items-center">
    <span className="font-bold text-lg text-[#a3e635]" style={{ filter: `drop-shadow(0 0 5px #a3e635)` }}>
      Ion
    </span>
    <span className="text-neutral-300 text-sm mt-1">Style Button</span>
  </div>
...
>
   <div className="relative z-10 flex flex-col items-center">
    <span className="font-bold text-lg text-[#4ade80]" style={{ filter: `drop-shadow(0 0 5px #4ade80)` }}>
      Fusion
    </span>
    <span className="text-neutral-300 text-sm mt-1">Style Button</span>
  </div>
...
>
   <div className="relative z-10 flex flex-col items-center">
    <span className="font-bold text-lg text-[#60a5fa]" style={{ filter: `drop-shadow(0 0 5px #60a5fa)` }}>
      Quantumab
    </span>
    <span className="text-neutral-300 text-sm mt-1">Style Button</span>
  </div>
