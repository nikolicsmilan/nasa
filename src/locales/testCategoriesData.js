...
export const testCategoriesData = [
  // <<< FIGYELEM: Az exportált név itt HELYES!
  {
    ...
    components: [
      // A kategórián belüli tesztkomponensek
      {
        ...
        description:
          "Test fetching and displaying data from the NASA Sentry System API via the custom backend.",
  ...
  },
  {
    ...
    components: [
      ...
      cs(
        "Paginated Table",
        "Table that breaks down large datasets into pages."
      ),
    ],
  },
  {
    ...
    components: [
      ...
      cs(
        "Multi-Stat Box",
        "A compact box showing multiple related statistics."
      ),
    ],
  },
  {
  ...
  },
  {
    ...
    components: [cs("Event Timeline", "Chronological display of events.")],
  },
  {
    key: "maps",
    name: "Maps (Styled)",
  ...
  },
  {
    ...
    components: [cs("Hover Tooltip", "Informational pop-up on hover.")],
  },
  {
    key: "badges",
    name: "Badges / Tags",
