...
import {
  ...
  FaMapMarkedAlt, FaListUl, FaCommentDots, FaTags, FaBars, FaHourglassHalf
} from 'react-icons/fa';
...
export const testPageComponentsData = [
  ...
  { key: "charts", name: "Charts / Graphs", Icon: FaChartBar, components: [cs("Area Chart"), cs("Bar Chart"), cs("Pie Chart"), cs("Radar Chart"), cs("Scatter Chart"), cs("Heatmap (Chart)")] },
  { key: "cards", name: "Cards", Icon: FaClone, components: [cs("Info Card"), cs("Statistic Card"), cs("Action Card")] },
  { key: "tables", name: "Tables", Icon: FaTable, components: [cs("Simple Data Table"), cs("Sortable Table"), cs("Paginated Table")] },
  { key: "kpi", name: "KPI Tiles / Stat Boxes", Icon: BsKanban, components: [cs("Single KPI Tile"), cs("Multi-Stat Box")] },
  { key: "progress", name: "Progress / Spinners", Icon: FaHourglassHalf, components: [cs("Linear Progress Bar"), cs("Circular Progress"), cs("Loading Spinner")] },
  { key: "inputs", name: "Input Fields / Forms", Icon: FaAlignLeft, components: [cs("Text Input"), cs("Number Input"), cs("Date Picker"), cs("Search Bar"), cs("Full Form Example")] },
  { key: "dropdowns", name: "Dropdowns / Selects", Icon: FaBars, components: [cs("Simple Dropdown"), cs("Styled Select")] },
  { key: "toggles", name: "Toggles / Switches", Icon: IoToggle, components: [cs("Basic Toggle"), cs("Styled Switch")] },
  { key: "sliders", name: "Sliders", Icon: FaSlidersH, components: [cs("Range Slider"), cs("Value Slider")] },
  { key: "alerts", name: "Alerts / Notifications", Icon: FaBell, components: [cs("Info Alert"), cs("Success Alert"), cs("Warning Alert"), cs("Error Alert"), cs("Toast Notification")] },
  { key: "modals", name: "Modals / Dialogs", Icon: FaWindowMaximize, components: [cs("Confirmation Modal"), cs("Info Dialog")] },
  { key: "tabs", name: "Tabs", Icon: FaTasks, components: [cs("Horizontal Tabs"), cs("Vertical Tabs")] },
  { key: "timelines", name: "Timelines", Icon: FaProjectDiagram, components: [cs("Event Timeline")] },
  { key: "maps", name: "Maps (Styled)", Icon: FaMapMarkedAlt, components: [cs("Abstract Location Map")] },
  { key: "lists", name: "Lists", Icon: FaListUl, components: [cs("Simple List"), cs("Interactive List")] },
  { key: "tooltips", name: "Tooltips", Icon: FaCommentDots, components: [cs("Hover Tooltip")] },
  { key: "badges", name: "Badges / Tags", Icon: FaTags, components: [cs("Status Badge"), cs("Category Tag")] },
  { key: "accordions", name: "Accordions", Icon: FaBars, components: [cs("Collapsible Panel")] }
];