// tailwind.config.js - TELJES, VÉGLEGESNEK SZÁNT
module.exports = {
  ...
  theme: {
    extend: { // Globális kiterjesztések
      ...
      colors: { // ALAP színpaletták (OKLCH)
    ...
    require("tailwindcss-themer")({
      ...
      themes: [
        // --- PLASMA TÉMA ---
        {
          name: "plasma",
          extend: {
            colors: { primary: 'oklch(74.6% 0.16 232.661)', success: "rgb(63, 178, 121)", info: "rgb(191, 191, 191)", dark: "rgb(0, 0, 0)", asidebg: "rgb(129, 171, 178)" },
            backgroundImage: {
            ...
            borderColor: { 'button-theme': 'oklch(74.6% 0.16 232.661 / 0.4)', 'button-theme-hover': 'oklch(74.6% 0.16 232.661 / 0.7)' }, // sky-400
            boxShadow:   { 'button-theme-hover': '0 0 15px oklch(74.6% 0.16 232.661)' }, // sky-400 glow
            dropShadow:  { 'text-theme': '0 0 5px oklch(74.6% 0.16 232.661 / 0.9)' } // sky-400 text glow (90% opacitás)
          },
        },
        // --- ION TÉMA ---
        {
          name: "ion",
          extend: {
            colors: { primary: 'oklch(84.1% 0.238 128.85)', success: "rgb(63, 178, 121)", info: "rgb(191, 191, 191)", dark: "rgb(0, 0, 0)", asidebg: "rgb(129, 171, 178)" },
            backgroundImage: {
            ...
            borderColor: { 'button-theme': 'oklch(84.1% 0.238 128.85 / 0.4)', 'button-theme-hover': 'oklch(84.1% 0.238 128.85 / 0.7)' }, // lime-400
            boxShadow:   { 'button-theme-hover': '0 0 15px oklch(84.1% 0.238 128.85)' }, // lime-400 glow
            dropShadow:  { 'text-theme': '0 0 5px oklch(84.1% 0.238 128.85 / 0.9)' } // lime-400 text glow
          },
        },
        // --- FUSION TÉMA ---
        {
          name: "fusion",
          extend: {
            colors: { primary: 'oklch(76.2% 0.196 154.8)', success: "rgb(63, 178, 121)", info: "rgb(191, 191, 191)", dark: "rgb(0, 0, 0)", asidebg: "rgb(129, 171, 178)" },
             backgroundImage: {
             ...
             borderColor: { 'button-theme': 'oklch(76.2% 0.196 154.8 / 0.4)', 'button-theme-hover': 'oklch(76.2% 0.196 154.8 / 0.7)' }, // green-400
            boxShadow:   { 'button-theme-hover': '0 0 15px oklch(76.2% 0.196 154.8)' }, // green-400 glow
            dropShadow:  { 'text-theme': '0 0 5px oklch(76.2% 0.196 154.8 / 0.9)' } // green-400 text glow
          },
        },
        // --- QUANTUM TÉMA ---
        {
          name: "quantum",
          extend: {
             colors: { primary: 'oklch(70.7% 0.165 254.624)', success: "rgb(237, 237, 237)", info: "rgb(40, 164, 241, 0.938)", dark: "rgb(0, 0, 0)", asidebg: "rgb(237, 237, 237)" },
             backgroundImage: {
             ...
             borderColor: { 'button-theme': 'oklch(70.7% 0.165 254.624 / 0.4)', 'button-theme-hover': 'oklch(70.7% 0.165 254.624 / 0.7)' }, // blue-400
            boxShadow:   { 'button-theme-hover': '0 0 15px oklch(70.7% 0.165 254.624)' }, // blue-400 glow
            dropShadow:  { 'text-theme': '0 0 5px oklch(70.7% 0.165 254.624 / 0.9)' } // blue-400 text glow
          },
        },
      ], // themes vége
    }), // require vége
